...
$string['colorpalette_desc'] = 'The colors that appear as palette in the color picker';
...
$string['paths'] = 'Paths';
$string['placecolor'] = 'Place color';
$string['placecolor_help'] = 'This color will be used for the places (if it is unvisited).';
$string['places'] = 'Places';
$string['placesettings'] = 'Place settings';
$string['placeemoji'] = 'Place emoji';
$string['placeemoji_help'] = 'This emoji will be used for unvisited places.';
$string['placesize'] = 'Place size';
$string['placesize_help'] = 'This size will be used for the places.';
...
$string['strokecolor_help'] = 'This color will be used for the stroke of the places, for the paths and the text.';
$string['svgcode'] = 'SVG code';
$string['targetplace'] = 'Target place';
$string['textcolor'] = 'Text color';
$string['textcolor_help'] = 'This color will be used for the activity names.';
...
$string['visitedcolor'] = 'Visited place color';
$string['visitedcolor_help'] = 'This color will be used for the places (if it is visited).';
$string['visitedemoji'] = 'Visited place emoji';
$string['visitedemoji_help'] = 'This emoji will be used for visited places.';
